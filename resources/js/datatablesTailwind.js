...
!(function (n) {
    ...
    var C,
                      ...
                      if ("table" != this.nodeName.toLowerCase()) $(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                          ...
                          var u,
                              ...
                              n =
                                  ...
                                  (t = te(H.extend(!0, {}, a), t)),
                                  z(c.oFeatures, t, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]),
                                  z(c, t, [
                                      "ajax",
                                      "fnFormatNumber",
                                      "sServerMethod",
                          ...
                          else if (n.length) for (R = n[(e = 0)].length; e < R; e++) h.push(null);
                          ...
                          var n = r.children("caption"),
                              n =
                                  (c.caption && (n = 0 === n.length ? H("<caption/>").appendTo(r) : n).html(c.caption),
        ...
        g =
            ...
            H.extend(C, { afnFiltering: C.search, aTypes: C.type.detect, ofnSearch: C.type.search, oSort: C.type.order, afnSortData: C.order, aoFeatures: C.feature, oStdClasses: C.classes, oPagination: C.pager }),
            H.extend(V.ext.classes, {
                ...
                tbody: { cell: "", row: "bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600" },
                thead: { cell: "", row: "text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400" },
                tfoot: { cell: "", row: "" },
                ...
                : ((f = function (t, e, n) {
                      for (var a, r, o, i, l = gt(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
                          ...
                          if (((a = l[s].match(pt)), (r = l[s].match(p)), a)) {
                              if (((l[s] = l[s].replace(pt, "")), (t[l[s]] = []), (a = l.slice()).splice(0, s + 1), (i = a.join(".")), Array.isArray(e))) for (var c = 0, d = e.length; c < d; c++) f((o = {}), e[c], i), t[l[s]].push(o);
                              else t[l[s]] = e;
                              return;
                          }
    ...
    function tt(t) {
        var e = V.defaults.column,
            ...
            e = H.extend({}, V.models.oColumn, e, { aDataSort: e.aDataSort || [n], mData: e.mData || n, idx: n, searchFixed: {}, colEl: H("<col>").attr("data-dt-column", n) }),
            ...
            for (
                f.append(H(e.nTHead).clone()).append(H(e.nTFoot).clone()),
                    ...
                    f.find("thead th, thead td").each(function () {
                        var t = ct(e, this, !0, !1);
                        t ? ((this.style.width = t), (this.style.minWidth = t), s && H(this).append(H("<div/>").css({ width: t, margin: 0, padding: 0, border: 0, height: 1 }))) : (this.style.width = "");
                    }),
                    n = 0;
                n < u.length;
                n++
    ...
    function st(t) {
        ...
        if ("ssp" !== J(t))
            for (e = 0, n = u.length; e < n; e++) {
                if (((s = []), !(l = u[e]).sType && l._sManualType)) l.sType = l._sManualType;
                else if (!l.sType) {
                    for (a = 0, r = d.length; a < r; a++) {
                        ...
                        for (o = 0, i = c.length; o < i; o++)
                            if (c[o]) {
                                if ((void 0 === s[o] && (s[o] = q(t, o, e, "type")), h && !v && (v = lt(f, h(s[o], t))), !(m = lt(f, p(s[o], t))) && a !== d.length - 3)) break;
                ...
                var b = C.type.className[l.sType],
                    b = (b && (ut(t.aoHeader, e, b), ut(t.aoFooter, e, b)), C.type.render[l.sType]);
                if (b && !l._render) {
                    (l._render = V.util.get(b)), (y = w = S = x = D = void 0);
                    for (var y, D = t, x = e, S = D.aoData, w = 0; w < S.length; w++) S[w].nTr && ((y = q(D, w, x, "display")), (S[w].displayData[x] = y), ht(S[w].anCells[x], y));
                }
            }
    }
    function ut(t, e, n) {
    ...
    function D(t, e, n, a) {
        for (var r = t.aoData.length, o = H.extend(!0, {}, V.models.oRow, { src: n ? "dom" : "data", idx: r }), i = ((o._aData = e), t.aoData.push(o), t.aoColumns), l = 0, s = i.length; l < s; l++) i[l].sType = null;
    ...
    function q(t, e, n, a) {
        ...
        if (r) {
            ...
            if (void 0 === (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s))
                return t.iDrawError != o && null === l && ($(t, 0, "Requested unknown parameter " + ("function" == typeof i.mData ? "{function}" : "'" + i.mData + "'") + " for row " + e + ", column " + n, 4), (t.iDrawError = o)), l;
    ...
    function xt(t, e, n, a) {
        ...
        if (null === c.nTr) {
            for (r = n || _.createElement("tr"), c.nTr = r, c.anCells = f, y(r, h), r._DT_RowIndex = e, St(t, c), l = 0, s = t.aoColumns.length; l < s; l++) {
                (i = t.aoColumns[l]), (o = (u = !n || !a[l]) ? _.createElement(i.sCellType) : a[l]) || $(t, 0, "Incorrect column count", 18), (o._DT_CellIndex = { row: e, column: l }), f.push(o);
                var p = Dt(t, e);
                (!u && ((!i.mRender && i.mData === l) || (H.isPlainObject(i.mData) && i.mData._ === l + ".display"))) || ht(o, p[l]),
                    y(o, i.sClass),
                    i.bVisible && u ? r.appendChild(o) : i.bVisible || u || o.parentNode.removeChild(o),
                    i.fnCreatedCell && i.fnCreatedCell.call(t.oInstance, o, q(t, e, l), d, e, l);
            }
    ...
    function St(t, e) {
        ...
        n &&
            ...
            a.DT_RowClass && ((t = a.DT_RowClass.split(" ")), (e.__rowc = e.__rowc ? x(e.__rowc.concat(t)) : t), H(n).removeClass(e.__rowc.join(" ")).addClass(a.DT_RowClass)),
    ...
    function S(t, e) {
        if (
                    ...
                    return (
                        ...
                        void Ft(
                            ...
                            function (t) {
                                ...
                                (e.aiDisplay = e.aiDisplayMaster.slice()), S(e, !0), Ht(e), w(e, !1);
                            }
                        )
                    );
            } else t.iDraw++;
            ...
            G(t, "aoHeaderCallback", "header", [H(t.nTHead).children("tr")[0], vt(t), i, s, o]),
                G(t, "aoFooterCallback", "footer", [H(t.nTFoot).children("tr")[0], vt(t), i, s, o]),
                c[0].replaceChildren ? c[0].replaceChildren.apply(c[0], n) : (c.children().detach(), c.append(H(n))),
                H(t.nTableWrapper).toggleClass("dt-empty-footer", 0 === H("tr", t.nTFoot).length),
    ...
    function Ct(t) {
        ...
        return (
            ...
            H("<tr/>").append(H("<td />", { colSpan: ot(t), class: t.oClasses.empty.row }).html(n))[0]
        );
    }
    function Lt(t, e, r) {
        var o = [];
        H.each(e, function (t, e) {
            var n, a;
            null !== e &&
                ((n = (t = t.match(/^([a-z]+)([0-9]*)([A-Za-z]*)$/))[2] ? +t[2] : 0), (a = t[3] ? t[3].toLowerCase() : "full"), t[1] === r) &&
                (function t(e, n, a) {
                    if (Array.isArray(a)) for (var r = 0; r < a.length; r++) t(e, n, a[r]);
                    else {
                        var o = e[n];
                        H.isPlainObject(a)
                            ? a.features
                                ? (a.rowId && (e.id = a.rowId), a.rowClass && (e.className = a.rowClass), (o.id = a.id), (o.className = a.className), t(e, n, a.features))
    ...
    function It(e) {
        ...
        n.oFeatures.bProcessing &&
            ((a = H("<div/>", { id: n.sTableId + "_processing", class: n.oClasses.processing.container, role: "status" })
                        ...
                        b = (b = +r.getAttribute("colspan")) && 0 != b && 1 != b ? b : 1,
                            ...
                            n &&
                                (s &&
                                    ...
                                    d ? (null === g.sTitle || g.autoTitle || (r.innerHTML = g.sTitle), !g.sTitle && s && ((g.sTitle = L(r.innerHTML)), (g.autoTitle = !0))) : g.footer && (r.innerHTML = g.footer),
    ...
    function Ft(n, t, a) {
        function e(t) {
            ...
            if (((null === t || ("number" == typeof e && 204 == e)) && Nt(n, (t = {}), []), (e = t.error || t.sError) && $(n, 0, e), t.d && "string" == typeof t.d))
                try {
                    t = JSON.parse(t.d);
                } catch (t) {}
        ...
        var r,
            ...
            i = n.oInstance,
            l =
                (H.isPlainObject(o) && o.data && ((l = "function" == typeof (r = o.data) ? r(t, n) : r), (t = "function" == typeof r && l ? l : H.extend(!0, t, l)), delete o.data),
                {
        ...
        H.isPlainObject(o) && H.extend(l, o),
            ...
            "function" == typeof o ? (n.jqXHR = o.call(i, t, e, n)) : "" === o.url ? ((i = {}), V.util.set(o.dataSrc)(i, []), e(i)) : (n.jqXHR = H.ajax(l)),
            r && (o.data = r);
    }
    function Nt(t, e, n) {
        var a = "data";
        if ((H.isPlainObject(t.ajax) && void 0 !== t.ajax.dataSrc && ("string" == typeof (t = t.ajax.dataSrc) || "function" == typeof t ? (a = t) : void 0 !== t.data && (a = t.data)), !n))
            ...
            for (var a, r, o, i, l, s = n, u = s.aoColumns, c = s.aoData, d = 0; d < c.length; d++)
                if (c[d] && !(l = c[d])._aFilterData) {
                    for (o = [], a = 0, r = u.length; a < r; a++)
                        u[a].bSearchable ? "string" != typeof (i = null === (i = q(s, d, a, "filter")) ? "" : i) && i.toString && (i = i.toString()) : (i = ""),
                            i.indexOf && -1 !== i.indexOf("&") && ((Et.innerHTML = i), (i = kt ? Et.textContent : Et.innerText)),
                ...
                var o = 0,
                    ...
                    s =
                        n instanceof RegExp
                            ...
                            : (function (t, e) {
                                  var a = [],
                                      e = H.extend({}, { boundary: !1, caseInsensitive: !0, exact: !1, regex: !1, smart: !0 }, e);
            ...
            ? (wt(i, "header"),
              ...
              (n = function () {
                  ...
                  !0 === r ? (e = a[0]) : !1 === r && (e = a[a.length - 1]),
                      $t(t, e, e === t.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o),
                      Yt(t, (r = []), t.aaSorting),
                      (t.aaSorting = r),
                      Ut(i),
                      w(i, !0),
    ...
    function qt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) (e.scrollBarVis = f), nt(e);
            ...
            a.css("width", I(b)),
                ...
                c && (l.css("width", I(b)), i.css("width", I(b)).css(f, s ? t + "px" : "0px")),
    ...
    function Jt(t, e, n) {
        var a,
            ...
            f = t.aoData,
            u = t.aiDisplayMaster;
        for (void 0 !== e ? ((l = t.aoColumns[e]), (c = [{ src: e, col: e, dir: n, index: 0, type: l.sType, formatter: s[l.sType + "-pre"], sorter: s[l.sType + "-" + n] }]), (u = u.slice())) : (c = Gt(t)), a = 0, r = c.length; a < r; a++) {
            ...
            for (var D = V.ext.type.order[b.sType + "-pre"], x = v.aoData, S = 0; S < x.length; S++)
                x[S] && ((p = x[S])._aSortData || (p._aSortData = []), (p._aSortData[m] && !y) || ((g = y ? h[S] : q(v, S, m, "sort")), (p._aSortData[m] = D ? D(g, v) : g)));
        }
        ...
        if (t && t.time) {
            ...
            if (0 < l && t.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
                ...
                if (
                    ...
                    void 0 !== t.start && (null === i ? ((n._iDisplayStart = t.start), (n.iInitDisplayStart = t.start)) : Xt(n, t.start / n._iDisplayLength)),
                    void 0 !== t.order &&
                        ((n.aaSorting = []),
    ...
    function te(t, e, n) {
        ...
        for (r in e)
            Object.prototype.hasOwnProperty.call(e, r) &&
                ((a = e[r]), H.isPlainObject(a) ? (H.isPlainObject(t[r]) || (t[r] = {}), H.extend(!0, t[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? (t[r] = a.slice()) : (t[r] = a));
        return t;
    }
    function ee(t, e, n) {
        H(t)
    ...
    function G(e, t, n, a, r) {
        ...
        return (
            ...
            null !== n && ((t = H.Event(n + ".dt")), (n = H(e.nTable)), (t.dt = e.api), n[r ? "trigger" : "triggerHandler"](t, a), r && 0 === n.parents("body").length && H("body").trigger(t, a), o.push(t.result)),
            o
        );
    }
    function ne(t) {
    ...
    (X = function (t, e) {
            ...
            var n,
                ...
                r = t
                    ? t.nTable && t.oFeatures
                        ...
                        ? t.settings().toArray()
                        : ("string" == typeof t ? (n = H(t).get()) : t instanceof H && (n = t.get()),
                          n
            ...
            iterator: function (t, e, n, a) {
                ...
                for ("string" == typeof t && ((a = n), (n = e), (e = t), (t = !1)), o = 0, i = h.length; o < i; o++) {
                    ...
                    if ("table" === e) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);
                        ...
                        for (c = this[o], "column-rows" === e && (u = ve(h[o], p.opts)), l = 0, s = c.length; l < s; l++)
        ...
        (X.register = e = function (t, e) {
            if (Array.isArray(t)) for (var n = 0, a = t.length; n < a; n++) X.register(t[n], e);
            else
    ...
    function ue(t) {
        return (t = t || {}).filter && void 0 === t.search && (t.search = t.filter), H.extend({ search: "none", order: "current", page: "all" }, t);
    }
    function ce(t) {
                ...
                : this.iterator(
                      ...
                      function (t) {
                          var e = H(t.nTable),
                              n = H(t.captionNode),
                              a = H(t.nTableWrapper);
                          n.length || ((n = H("<caption/>").html(r)), (t.captionNode = n[0]), o) || (e.prepend(n), (o = n.css("caption-side"))),
                              n.html(r),
        ...
        e("page.info()", function () {
            ...
            if (0 !== this.context.length)
                return (
                    ...
                    { page: (r = -1 === n) ? 0 : Math.floor(e / n), pages: r ? 1 : Math.ceil(a / n), start: e, end: t.fnDisplayEnd(), length: n, recordsTotal: t.fnRecordsTotal(), recordsDisplay: a, serverSide: "ssp" === J(t) }
                );
        }),
    ...
    function de(o, i, t, e) {
        function l(t, e) {
            var n;
            if (Array.isArray(t) || t instanceof H) for (var a = 0, r = t.length; a < r; a++) l(t[a], e);
            else
                t.nodeName && "tr" === t.nodeName.toLowerCase()
                    ? (t.setAttribute("data-dt-row", i.idx), s.push(t))
                    : ((n = H("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(e)), (H("td", n).addClass(e).html(t)[0].colSpan = ot(o)), s.push(n[0]));
        }
        var s = [];
    ...
    var ve = function (t, e) {
                                ...
                                function (n) {
                                    ...
                                    if (n.nodeName)
                                        return (
                                            (t = n._DT_RowIndex),
                                            (e = n._DT_CellIndex),
                                            void 0 !== t ? (a[t] && a[t].nTr === n ? [t] : []) : e ? (a[e.row] && a[e.row].nTr === n.parentNode ? [e.row] : []) : (t = H(n).closest("*[data-dt-row]")).length ? [t.data("dt-row")] : []
                                        );
            ...
            e("row().data()", function (t) {
                ...
                return void 0 === t
                    ? n.length && this.length && this[0].length
                        ...
                        : void 0
                    : (((e = n[0].aoData[this[0]])._aData = t), Array.isArray(t) && e.nTr && e.nTr.id && v(n[0].rowId)(t, e.nTr.id), bt(n[0], this[0], "data"), this);
            }),
            e("row().node()", function () {
                var t = this.context;
            ...
            (e(xe, function (t, e) {
                ...
                return void 0 === t
                    ? n.length && this.length && n[0].aoData[this[0]]
                        ...
                        : void 0
                    : (!0 === t ? this.child.show() : !1 === t ? ye(this) : n.length && this.length && de(n[0], n[0].aoData[this[0]], t, e), this);
            }),
        ...
        xe =
                ...
                var e = this,
                    ...
                    t = this.iterator("column", function (t, e) {
                        ...
                        !(function (t, e, n) {
                            ...
                            if (n) for (var s = m(o, "bVisible").indexOf(!0, e + 1), u = 0, c = l.length; u < c; u++) l[u] && ((r = l[u].nTr), (a = l[u].anCells), r) && r.insertBefore(a[e], a[s] || null);
                ...
                return (
                    void 0 !== n &&
                        this.iterator("table", function (t) {
                            _t(t, t.aoHeader),
                                _t(t, t.aoFooter),
                                t.aiDisplay.length || H(t.nTBody).find("td[colspan]").attr("colspan", ot(t)),
                                Qt(t),
            ...
            e("cells()", function (g, t, v) {
                var a, r, o, i, l, s, e;
                return (
                    H.isPlainObject(g) && (void 0 === g.row ? ((v = g), (g = null)) : ((v = t), (t = null))),
                                  ...
                                  se(
                                      ...
                                      function (t) {
                                          var e,
                                              n = "function" == typeof t;
                                          if (null == t || n) {
                                              for (o = [], i = 0, l = f.length; i < l; i++) for (r = f[i], s = 0; s < p; s++) (u = { row: r, column: s }), (!n || ((c = d[r]), t(u, q(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                                              return o;
                                          }
            ...
            e("cell().data()", function (t) {
                ...
                return void 0 === t
                    ? i.length && l.length
                        ...
                        : void 0
                    : ((e = i[0]), (n = l[0].row), (a = l[0].column), (r = e.aoColumns[a]), (o = e.aoData[n]._aData), r.fnSetData(o, t, { settings: e, row: n, col: a }), bt(i[0], l[0].row, "data", l[0].column), this);
            }),
            ...
            e("search()", function (e, n, a, r) {
                ...
                return void 0 === e
                    ...
                    : this.iterator("table", function (t) {
                          t.oFeatures.bFilter &&
                              Rt(t, "object" == typeof n ? H.extend(t.oPreviousSearch, n, { search: e }) : H.extend(t.oPreviousSearch, { search: e, regex: null !== n && n, smart: null === a || a, caseInsensitive: null === r || r }));
                      });
            }),
            ...
            t("columns().search()", "column().search()", function (a, r, o, i) {
                return this.iterator("column", function (t, e) {
                    ...
                    t.oFeatures.bFilter &&
                        ("object" == typeof r ? H.extend(n[e], r, { search: a }) : H.extend(n[e], { search: a, regex: null !== r && r, smart: null === o || o, caseInsensitive: null === i || i }), Rt(t, t.oPreviousSearch));
                });
            }),
            ...
            pagingButton: {
                _: function (t, e, n, a, r) {
                    ...
                    return (
                        a && o.push(t.active),
                        r && o.push(t.disabled),
                        { display: (a = "ellipsis" === e ? H('<span class="ellipsis"></span>').html(n)[0] : H("<button>", { class: o.join(" "), role: "link", type: "button" }).html(n)), clicker: a }
                    );
                },
            },
            pagingContainer: {
                ...
                function (t, e) {
                    ...
                    return (
                        ...
                        "type" === e
                            ...
                            : !(null === r || a !== r || "sort" === e || "type" === e || t instanceof Date) || null === (n = _e(t, a, o))
                            ? t
                            : "sort" === e
                            ? n
                            : ((t = null === r ? we(n, "toDate", "toJSDate", "")[s]() : we(n, "format", "toFormat", "toISOString", r)), "display" === e ? u(t) : t)
                    );
                }
            );
        };
    ...
    function Fe(t, e) {
        return (t = t.toString().toLowerCase()), (e = e.toString().toLowerCase()), t.localeCompare(e, navigator.languages[0] || navigator.language, { numeric: !0, ignorePunctuation: !0 });
    }
    var l = V.ext.type,
        Ne =
            ((V.type = function (n, t, e) {
                ...
                void 0 === e && ((e = t), (t = null)),
                    "className" === t
                        ...
                        : "search" === t
                        ? a("search", e)
                        : t || (e.className && a("className", e.className), void 0 !== e.detect && r(e.detect), e.order && o(e.order), void 0 !== e.render && a("render", e.render), void 0 !== e.search && a("search", e.search));
            }),
            (V.types = function () {
        ...
        header: {
            _: function (p, g, v) {
                ...
                "disable" === g.attr("data-dt-order") ||
                    ...
                    (!0 === t && 0 !== n) ||
                    (!1 === t && n !== e.length - 1) ||
                    H(p.nTable).on("order.dt.DT column-visibility.dt.DT", function (t, e) {
                        if (p === e) {
                            var n = e.sortDetails;
                            if (n) {
                                for (
                                ...
                                s[0] == h ? ((r = n[0]), (u = o.asSorting), g.attr("aria-sort", "asc" === r.dir ? "ascending" : "descending"), (l = u[r.index + 1] ? "Reverse" : "Remove")) : g.removeAttr("aria-sort"),
                                    g.attr("aria-label", i ? o.ariaTitle + e.api.i18n("oAria.orderable" + l) : o.ariaTitle),
            ...
            _: function (t, e, n) {
                ...
                H.each(n, function (t, e) {
                    ...
                    "id" !== t &&
                        ...
                        H("<div/>")
                            .attr({ id: e.id || null, class: e.className || a.cell + " " + n })
                            .append(e.contents)
                            .appendTo(r));
                });
            },
            ...
            function (t, s) {
                ...
                return t.oFeatures.bInfo
                    ? ((e = t.oLanguage),
                      ...
                      (s = H.extend({ callback: e.fnInfoCallback, empty: e.sInfoEmpty, postfix: e.sInfoPostFix, search: e.sInfoFiltered, text: e.sInfo }, s)),
                      ...
                      t._infoEl || (u.attr({ "aria-live": "polite", id: n + "_info", role: "status" }), H(t.nTable).attr("aria-describedby", n + "_info"), (t._infoEl = u)),
                      u)
                    : null;
            },
            "i"
    ...
    V.feature.register(
        ...
        function (n, a) {
            ...
            return n.oFeatures.bFilter
                ? ((t = n.oClasses.search),
                  ...
                  -1 === (a = H.extend({ placeholder: c.sSearchPlaceholder, processing: !1, text: c.sSearch }, a)).text.indexOf("_INPUT_") && (a.text += "_INPUT_"),
                  (a.text = re(n, a.text)),
        ...
        V.feature.register(
            ...
            function (t, e) {
                ...
                e = H.extend({ buttons: V.ext.pager.numbers_length, type: t.sPaginationType, boundaryNumbers: !0, firstLast: !0, previousNext: !0, numbers: !0 }, e);
                function n() {
                    !(function t(e, n, a) {
                ...
                var a = H("<div/>")
                    .addClass(t.oClasses.paging.container + (e.type ? " paging_" + e.type : ""))
                    .append(H("<nav>").attr("aria-label", "pagination").addClass(t.oClasses.paging.nav));
    ...
    return (
        V.feature.register(
            ...
            function (a, t) {
                ...
                else for (p = 0; p < r.length; p++) H.isPlainObject(r[p]) ? (o.push(r[p].value), i.push(r[p].label)) : (o.push(r[p]), i.push(r[p]));
                for (
                    var l = t.text.match(/_MENU_$/),
                        s = t.text.match(/^_MENU_/),
                        u = t.text.replace(/_MENU_/, ""),
                        t = "<label>" + t.text + "</label>",
                        s = (s ? (t = "_MENU_<label>" + u + "</label>") : l && (t = "<label>" + u + "</label>_MENU_"), "tmp-" + +new Date()),
                        c = H("<div/>")
                        ...
                        h = H("<select/>", { name: n + "_length", "aria-controls": n, class: e.select }),
                        p = 0;
                    p < o.length;
                    p++
                )
