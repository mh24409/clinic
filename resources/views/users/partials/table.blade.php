{{-- <table id="export-table">
        ...
        <tr>
            <th>
                <span class="flex items-center">
                    <x-inc.input type="checkbox"
                    class="p-0 ps-0" name="check_all" />
                </span>
            </th>
            <th>
                <span class="flex items-center">
    ...
    <tbody>
        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
            ...
            <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white flex gap-2 align-center">
                <img src="{{ Vite::asset('resources/images/users/1.png') }}"
                    class="w-small-img h-small-img rounded-main" alt="" /> Flowbite
            </td>
            <td>01559470947</td>
            <td>269000</td>
        </tr>
